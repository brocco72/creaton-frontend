...
var locationUtils$1 = require('@hickory/location-utils');
    ...
    return {
        ...
        stringify: function (location) {
            ...
            var pathname = location.pathname !== undefined
                ...
                : "";
            return (pathname +
                locationUtils$1.ensureBeginsWith(stringifyQuery(location.query), "?") +
                locationUtils$1.ensureBeginsWith(location.hash, "#"));
        }
    };
}
